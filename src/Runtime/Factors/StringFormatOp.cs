...
namespace Microsoft.ML.Probabilistic.Factors
{
        ...
        where TThis : StringFormatOpBase<TThis>, new()
    {
        ...
        public static StringDistribution StrAverageConditional(StringDistribution format, IList<string> args, ReadOnlyArray<string> argNames)
        {
        ...
        public static StringDistribution StrAverageConditional(StringDistribution format, IList<StringDistribution> args, ReadOnlyArray<string> argNames)
        {
        ...
        public static StringDistribution StrAverageConditional_NoValidation(
            StringDistribution format, IList<StringDistribution> args, ReadOnlyArray<string> argNames)
        {
            Argument.CheckIfNotNull(format, "format");
            ValidateArguments(args, argNames);
        ...
        public static StringDistribution FormatAverageConditional(StringDistribution str, IList<string> args, ReadOnlyArray<string> argNames)
        {
            Argument.CheckIfNotNull(args, "args");
        ...
        public static StringDistribution FormatAverageConditional(StringDistribution str, IList<StringDistribution> args, ReadOnlyArray<string> argNames)
        {
        ...
        public static StringDistribution ToStrReverseMessage(StringDistribution format, IList<StringDistribution> args, ReadOnlyArray<string> argNames)
        {
            return ComputeToStrReverseMessage(format, args, argNames, true);
        }

        public static StringDistribution ComputeToStrReverseMessage(StringDistribution format, IList<StringDistribution> args, ReadOnlyArray<string> argNames, bool makeEpsilonFree)
        {
            var allowedArgs = args.Select(arg => arg.GetWorkspaceOrPoint()).ToList();
        ...
        public static TStringDistributionList ArgsAverageConditional<TStringDistributionList>(
            StringDistribution str, StringDistribution format, IList<StringDistribution> args, ReadOnlyArray<string> argNames, TStringDistributionList result)
        ...
        public static double LogEvidenceRatio(string str, StringDistribution format, IList<StringDistribution> args, ReadOnlyArray<string> argNames)
        {
            Argument.CheckIfNotNull(str, "str");
        ...
        public static double LogEvidenceRatio(string str, StringDistribution format, IList<string> args, ReadOnlyArray<string> argNames)
        {
            Argument.CheckIfNotNull(args, "args");
        ...
        /// <summary>
        /// An implementation of <see cref="FormatAverageConditional(StringDistribution, IList{StringDistribution}, ReadOnlyArray{string})"/>
        ...
        private static bool TryOptimizedFormatAverageConditionalImpl(
            StringDistribution str, IList<StringAutomaton> allowedArgs, ReadOnlyArray<string> argNames, out StringDistribution resultDist)
        {
            resultDist = null;
        ...
        /// <summary>
        /// The implementation of <see cref="StrAverageConditional(StringDistribution, IList{StringDistribution}, ReadOnlyArray{string})"/>.
        /// </summary>
        ...
        private static StringDistribution StrAverageConditionalImpl(
            StringDistribution format, IList<StringAutomaton> allowedArgs, ReadOnlyArray<string> argNames, bool withGroups, bool noValidation)
        {
        ...
        /// <summary>
        /// An implementation of <see cref="StrAverageConditional(StringDistribution, IList{StringDistribution}, ReadOnlyArray{string})"/>
        /// specialized for some cases for performance reasons.
        /// </summary>
        /// <param name="format">The message from <c>format</c>.</param>
        /// <param name="allowedArgs">The message from <c>args</c>, truncated to allowed values and converted to automata.</param>
        ...
        private static StringDistribution TryOptimizedStrAverageConditionalImpl(
            StringDistribution format, IList<StringAutomaton> allowedArgs, ReadOnlyArray<string> argNames, bool withGroups)
        {
        ...
        private static StringTransducer GetPlaceholderReplacingTransducer(
            IList<StringAutomaton> args, ReadOnlyArray<string> argNames, bool forBackwardMessage, bool withGroups)
        {
        ...
        private static StringAutomaton GetValidatedFormatString(StringAutomaton format, ReadOnlyArray<string> argNames)
        {
        ...
        private static StringAutomaton GetArgumentValidatingAutomaton(int argToValidateIndex, ReadOnlyArray<string> argNames)
        {
            Debug.Assert(
                !argNames.IsNull && argNames.All(name => !string.IsNullOrEmpty(name)),
        ...
        private static string ArgumentListToDictionaryKey(int argIndexToValidate, ReadOnlyArray<string> argNames)
        {
        ...
        /// <param name="argNames">The names of the arguments.</param>
        private static void ValidateArguments(IList<StringDistribution> args, ReadOnlyArray<string> argNames)
        {
            Argument.CheckIfNotNull(args, "args");
        ...
        where TStringFormatOp : StringFormatOpBase<TStringFormatOp>, new()
    {
        ...
        /// </summary>
        private static readonly ConcurrentDictionary<int, ReadOnlyArray<string>> ArgumentCountToNames = new ConcurrentDictionary<int, ReadOnlyArray<string>>();
        ...
        private static ReadOnlyArray<string> GetArgumentNames(int argCount)
        {
            ReadOnlyArray<string> result;
